...
gulp.task("copy", function() {
  ...
  // CSS, JS directories
  gulp.src("source/css/**").pipe(gulp.dest("dist/css"));
...
gulp.task("prod-copy", function() {
  // Specific files
  gulp.src(".htaccess").pipe(gulp.dest("prod"));

  gulp.src(".gitignore").pipe(gulp.dest("prod"));

  gulp.src("Gulpfile.js").pipe(gulp.dest("prod"));

  gulp.src("Readme").pipe(gulp.dest("prod"));

  gulp.src("package.json").pipe(gulp.dest("prod"));

  // CSS, JS directories
  gulp.src("source/css/**").pipe(gulp.dest("prod/css"));

  // CSS, JS directories
  gulp.src("source/*.html").pipe(gulp.dest("prod/"));

  gulp.src("source/js/**").pipe(gulp.dest("prod/js"));
});
...
gulp.task("watch", function() {
  ...
  gulp.watch("source/sass/itcss/*.scss", ["styles"]);
...
gulp.task(
  "default",
  ["styles", "express", "livereload", "watch"],
  function() {}
);
